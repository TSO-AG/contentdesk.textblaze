...
def getSecrets(environment):
    ...
    env_vars['BLAZE_DATA_ENDPOINT'] = getenv('BLAZE_DATA_ENDPOINT')
    env_vars['BLAZE_DATABASE_ID'] = getenv('BLAZE_DATABASE_ID')
    env_vars['BLAZE_TOKEN'] = getenv('BLAZE_TOKEN')
    env_vars['BLAZE_TABLE_ID'] = getenv('BLAZE_TABLE_ID')
